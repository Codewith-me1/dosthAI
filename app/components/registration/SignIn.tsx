...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 bg-[#FBFDFF] p-1 border-r-2 border-[#D5D5D5] flex-col justify-between min-h-screen relative hidden md:flex">
      ...
      {/* Right Section */}
      <div className="w-full md:w-1/2 md:p-10 bg-white p-10 flex items-center justify-center">
        <div className="w-full max-w-lg">
          <h2 className="text-4xl  font-bold text-[#3A3A3A]  mb-10">Sign In</h2>
          ...
          <div className="mt-8 space-y-4">
            <button className="w-full text-black font-medium flex items-center justify-center gap-4 px-5 py-4 border border-gray-300 rounded-4xl hover:bg-gray-50 transition-all duration-200 hover:scale-[0.98] hover:shadow-sm active:scale-[0.97] active:shadow-inner">
              <Image
            ...
            <button className="w-full flex items-center text-black font-medium justify-center gap-4 px-5 py-4 border border-gray-300 rounded-4xl hover:bg-gray-50 transition-all duration-200 hover:scale-[0.98] hover:shadow-sm active:scale-[0.97] active:shadow-inner">
              <Image
                src="/icons/apple.svg"
                alt="Apple"
                width={24}
