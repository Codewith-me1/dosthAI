...
export default function SignUp() {
  ...
  <div className=" -rotate-z-10 ">
    ...
    <div className="w-full max-w-lg"> {/* Increased from max-w-md to max-w-lg */}
        <h2 className="text-4xl font-bold text-[#3A3A3A] text-center mb-10">Create your collection today!</h2>
        
        <form onSubmit={handleSignupSubmit} className="space-y-6"> {/* Increased spacing */}
            {/* Name Input */}
            <div>
                <input
                    type="text"
            ...
            <div className="relative">
                ...
                <button
                    ...
                    className={errors.password?"absolute right-4 top-1/3 -translate-y-1/2":"absolute right-4 top-1/2 -translate-y-1/2"}

                >
                    {showPassword ? <Eye className='text-[#595959]'/> : <EyeOff className='text-[#595959]'/>}
                </button>
            ...
            <div className="relative">
                ...
                >
                    {showConfirmPassword ? <Eye className='text-[#595959]'/> : <EyeOff className='text-[#595959]'/>}
                </button>
