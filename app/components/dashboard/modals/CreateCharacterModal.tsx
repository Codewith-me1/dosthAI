  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-2xl w-full max-w-md md:max-w-2xl lg:max-w-5xl mx-auto relative shadow-xl max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        <button
          onClick={onClose}
          className="absolute right-3 top-3 sm:right-4 sm:top-4 text-gray-500 hover:text-gray-700 z-10 p-1 rounded-full hover:bg-gray-100"
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full placeholder-[#787878] px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent pr-10 text-sm sm:text-base" // Adjusted border and text size
                />
                {prompt && (
                  <button
                    type="submit"
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-3 sm:mb-4">
                Choose a sample prompt to create story
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                {samplePrompts.map((samplePrompt, index) => (
                  ...
                  >
                    <span className="text-[#FFC700] mr-2 flex-shrink-0">
                      <Quote className="w-4 rotate-180 fill-[#FFC700]" />
                    </span>
            ...
            <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-8 flex flex-col">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="bg-gray-100 p-3 sm:p-4 rounded-lg max-h-32 overflow-y-auto">
                  <p className="text-sm mb-10 text-gray-900 break-words">
                    {prompt}
                  </p>{" "}
                </div>
              </div>
                  ...
                  <span className="mr-1.5">
                    ...
                    >
                      ...
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M4 5V13C4 13.5523 4.44772 14 5 14H11C11.5523 14 12 13.5523 12 13V5H4ZM6 7H7V12H6V7ZM10 7H9V12H10V7Z"
                        fill="currentColor"
                      />{" "}
                      {/* Added trash can lines for clarity */}
