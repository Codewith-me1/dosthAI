...
export default function KidsProfile({ onBack }: KidsProfileProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setProfiles(prev => [...prev, { name: formData.name, age: formData.age }]);
        setFormData({
            name: '',
            age: '',
            conditions: [],
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row">
            {/* Left Section */}
            <div className="w-full md:w-1/2 bg-white p-8 flex flex-col justify-between min-h-screen relative">
                <div className="w-full max-w-md mx-auto">
                    ...
                    <div className="mb-8 mt-10">
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Add your kids profile</h1>
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">and start creating stories for them</h2>
                    </div>

                    {/* Profile Preview */}
                    <div className="relative">
                       <Image className='mt-30' src="/kidsprofile.png" alt='kids' width={600} height={600}/>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full md:w-1/2 bg-gray-50 p-8 flex items-center justify-center">
                <div className="w-full max-w-xl">
                    <h2 className="text-4xl font-bold text-[#6000fe] mb-4">Add your kids profile!</h2>
                    <p className="text-lg text-gray-600 mb-8">by adding you kids profile you can create and save stories for them in dedicated folder</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-xl font-semibold text-gray-700">Condition(s)</h3>
                                ...
                                {conditions.map((condition) => (
                                    <button
                                        ...
                                        className={` py-2  px-2  rounded-full text-sm font-medium transition-all
                                            ...
                                            ${formData.preferNotToSay ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}
                                        `}
                                    >
                                        {condition.label}
                                    </button>
