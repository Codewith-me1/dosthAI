...
const CarouselCard = () => {
  return (
    <section className="w-full mt-32 md:mt-40 px-4 md:px-6">
      ...
      >
        {/* Slide 1 */}
        <SwiperSlide className="3xl:max-w-[950px]">
          <div className="bg-[#FBFDFF]  3xl:max-w-[55rem] md:max-w-[40rem] h-auto md:h-[36rem] rounded-2xl p-6 md:p-10 flex flex-col gap-4 border border-[#C099FF]">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative flex items-center space-x-4 ml-10 sm:ml-20">
                <div className="absolute -left-10 top-0 hidden sm:flex flex-col items-center">
                  <Image
                    src="/landingImg/cards/Arrow1.svg"
                    width={25}
                    height={10}
                    alt="arrow"
                  />
              ...
              <div className="flex items-center gap-2 mt-[-10px] ml-10 sm:ml-20">
                <Image
                  alt="Arrow"
                  src="/landingImg/cards/Arrow2.svg"
                  width={30}
                  height={10}
                />
        ...
        <SwiperSlide className="3xl:max-w-[950px]">
          <div className="bg-[#FBFDFF] max-w-full  3xl:max-w-[55rem] md:max-w-[40rem] h-auto md:h-[36rem] rounded-2xl p-6 md:p-10 flex flex-col gap-4 border border-[#C099FF]">
            <h3 className="text-2xl md:text-3xl mb-1">
              Create{" "}
            ...
            <div className="relative">
              <Image
                alt="Alex"
                src="/landingImg/cards/AlexGrp.png"
                width={300}
                height={50}
              />
        ...
        <SwiperSlide className="3xl:max-w-[950px]">
          <div className="bg-[#FBFDFF] 3xl:max-w-[55rem] max-w-full md:max-w-[40rem] h-auto md:h-[36rem]  rounded-2xl p-6 md:p-8 flex flex-col gap-4 border border-[#C099FF] shadow-lg">
