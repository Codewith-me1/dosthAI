...
const PromptSection = () => {
  return (
    <section className="w-full 3xl:max-w-[150rem] justify-between z-10 pt-12 md:pt-16 md:px-20 lg:px-20 xl:px-30  mx-auto mt-32 md:mt-48 flex flex-col md:flex-row items-center gap-12 md:gap-8 px-2">
      {" "}
